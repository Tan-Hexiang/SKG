...
def main_LP(args):
    ...
    train_edge_idx, val_edges, val_edges_false, test_edges, test_edges_false = data_process_GAT.mask_test_edges_dgl(g, adj, args.train_ratio, args.valid_ratio)
    ...
    for epoch in range(args.epochs):
        ...
        val_roc, val_ap = data_process_GAT.get_scores(val_edges, val_edges_false, logits)
